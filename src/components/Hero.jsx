      ...
      <div className="max-w-3xl">
        ...
        >
          <p className="mb-4 inline-block bg-blue-700/20 px-3 py-1 rounded-full text-xs text-blue-300 font-semibold border border-blue-400">
            NEW &nbsp;•&nbsp; Trusted by Modern  Brands
          </p>

          <h1 className="text-3xl sm:text-4xl font-bold leading-tight mb-4">
            Scalable Web Solutions <br />
            <span className="text-blue-400">for personal brands and creators</span>
          </h1>

          <p className="text-base sm:text-lg text-gray-300 mb-8">
            At NexaForge, we build bold, conversion-driven websites, landing pages, and tools that help creators,coaches and personal brands monetize fast, look legit brand. and scale
